...
function Component() {
  ...
  const calculateProof = async () => {
    ...
    const upload = async () => {
      // const protectedData = await protector.protectData({
      //   data: {
      //     email: 'cheery.hope3057@fastmail.com',
      //     number: 59,
      //   },
      // });
      // console.log('protected', protectedData);

      const grantedAccess = await protector.grantAccess({
        protectedData: '0xAfcf40E8EE2165252884AeF0A9B19463Ad8F3eA4',
        authorizedApp: '0x891d56770ba2974b68744a21f0e5acac807407de',
        authorizedUser: '0x615bcacA28523Ba081071E68E818b44948c1DD5A',
      });
  ...
  const verifyInputProof = async () => {
    const sendEmail = await protectMailer.sendEmail({
      protectedData: '0xAfcf40E8EE2165252884AeF0A9B19463Ad8F3eA4',
      emailSubject: 'My email subject',
      emailContent: 'My email content',
    });
    console.log('email sending', sendEmail);
